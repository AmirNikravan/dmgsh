...
"            }")
        ...
        self.stackedWidget_bar = QStackedWidget(self.frame_32)
        self.stackedWidget_bar.setObjectName(u"stackedWidget_bar")
        self.stackedWidget_bar.setMaximumSize(QSize(900, 16777215))
        ...
        self.lcdNumber_speed = QLCDNumber(self.frame_26)
        self.lcdNumber_speed.setObjectName(u"lcdNumber_speed")
        self.lcdNumber_speed.setEnabled(False)
        self.lcdNumber_speed.setGeometry(QRect(50, 430, 54, 23))
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lcdNumber_speed.sizePolicy().hasHeightForWidth())
        self.lcdNumber_speed.setSizePolicy(sizePolicy)
        self.lcdNumber_speed.setMaximumSize(QSize(54, 16777215))
        self.lcdNumber_speed.setLayoutDirection(Qt.LeftToRight)
        ...
        self.progressBar_speed = QProgressBar(self.frame_26)
        self.progressBar_speed.setObjectName(u"progressBar_speed")
        self.progressBar_speed.setGeometry(QRect(50, 40, 61, 381))
        self.progressBar_speed.setStyleSheet(u"")
        self.progressBar_speed.setMaximum(2200)
        self.progressBar_speed.setValue(2100)
        self.progressBar_speed.setTextVisible(False)
        self.progressBar_speed.setOrientation(Qt.Vertical)
        ...
        self.lcdNumber_tempbanka = QLCDNumber(self.frame_27)
        self.lcdNumber_tempbanka.setObjectName(u"lcdNumber_tempbanka")
        self.lcdNumber_tempbanka.setEnabled(False)
        self.lcdNumber_tempbanka.setGeometry(QRect(50, 430, 54, 23))
        sizePolicy.setHeightForWidth(self.lcdNumber_tempbanka.sizePolicy().hasHeightForWidth())
        self.lcdNumber_tempbanka.setSizePolicy(sizePolicy)
        self.lcdNumber_tempbanka.setMaximumSize(QSize(54, 16777215))
        self.lcdNumber_tempbanka.setLayoutDirection(Qt.LeftToRight)
        ...
        self.progressBar_tempbanka = QProgressBar(self.frame_27)
        self.progressBar_tempbanka.setObjectName(u"progressBar_tempbanka")
        self.progressBar_tempbanka.setGeometry(QRect(50, 40, 61, 381))
        self.progressBar_tempbanka.setStyleSheet(u"")
        self.progressBar_tempbanka.setMaximum(1200)
        self.progressBar_tempbanka.setValue(1100)
        self.progressBar_tempbanka.setTextVisible(False)
        self.progressBar_tempbanka.setOrientation(Qt.Vertical)
        ...
        self.lcdNumber_tempbankb = QLCDNumber(self.frame_28)
        self.lcdNumber_tempbankb.setObjectName(u"lcdNumber_tempbankb")
        self.lcdNumber_tempbankb.setEnabled(False)
        self.lcdNumber_tempbankb.setGeometry(QRect(50, 430, 54, 23))
        sizePolicy.setHeightForWidth(self.lcdNumber_tempbankb.sizePolicy().hasHeightForWidth())
        self.lcdNumber_tempbankb.setSizePolicy(sizePolicy)
        self.lcdNumber_tempbankb.setMaximumSize(QSize(54, 16777215))
        self.lcdNumber_tempbankb.setLayoutDirection(Qt.LeftToRight)
        ...
        self.progressBar_tempbankb = QProgressBar(self.frame_28)
        self.progressBar_tempbankb.setObjectName(u"progressBar_tempbankb")
        self.progressBar_tempbankb.setGeometry(QRect(50, 40, 61, 381))
        self.progressBar_tempbankb.setStyleSheet(u"")
        self.progressBar_tempbankb.setMaximum(1200)
        self.progressBar_tempbankb.setValue(1100)
        self.progressBar_tempbankb.setTextVisible(False)
        self.progressBar_tempbankb.setOrientation(Qt.Vertical)
        ...
        self.lcdNumber_tempcoolera = QLCDNumber(self.frame_29)
        self.lcdNumber_tempcoolera.setObjectName(u"lcdNumber_tempcoolera")
        self.lcdNumber_tempcoolera.setEnabled(False)
        self.lcdNumber_tempcoolera.setGeometry(QRect(50, 430, 54, 23))
        sizePolicy.setHeightForWidth(self.lcdNumber_tempcoolera.sizePolicy().hasHeightForWidth())
        self.lcdNumber_tempcoolera.setSizePolicy(sizePolicy)
        self.lcdNumber_tempcoolera.setMaximumSize(QSize(54, 16777215))
        self.lcdNumber_tempcoolera.setLayoutDirection(Qt.LeftToRight)
        ...
        self.progressBar_tempcoolera = QProgressBar(self.frame_29)
        self.progressBar_tempcoolera.setObjectName(u"progressBar_tempcoolera")
        self.progressBar_tempcoolera.setGeometry(QRect(50, 40, 61, 381))
        self.progressBar_tempcoolera.setStyleSheet(u"")
        self.progressBar_tempcoolera.setMaximum(120)
        self.progressBar_tempcoolera.setValue(110)
        self.progressBar_tempcoolera.setTextVisible(False)
        self.progressBar_tempcoolera.setOrientation(Qt.Vertical)
        ...
        self.lcdNumber_tempcoolerb = QLCDNumber(self.frame_31)
        self.lcdNumber_tempcoolerb.setObjectName(u"lcdNumber_tempcoolerb")
        self.lcdNumber_tempcoolerb.setEnabled(False)
        self.lcdNumber_tempcoolerb.setGeometry(QRect(50, 430, 54, 23))
        sizePolicy.setHeightForWidth(self.lcdNumber_tempcoolerb.sizePolicy().hasHeightForWidth())
        self.lcdNumber_tempcoolerb.setSizePolicy(sizePolicy)
        self.lcdNumber_tempcoolerb.setMaximumSize(QSize(54, 16777215))
        self.lcdNumber_tempcoolerb.setLayoutDirection(Qt.LeftToRight)
        ...
        self.progressBar_tempcoolerb = QProgressBar(self.frame_31)
        self.progressBar_tempcoolerb.setObjectName(u"progressBar_tempcoolerb")
        self.progressBar_tempcoolerb.setGeometry(QRect(50, 40, 61, 381))
        self.progressBar_tempcoolerb.setStyleSheet(u"")
        self.progressBar_tempcoolerb.setMaximum(120)
        self.progressBar_tempcoolerb.setValue(110)
        self.progressBar_tempcoolerb.setTextVisible(False)
        self.progressBar_tempcoolerb.setOrientation(Qt.Vertical)
        ...
        self.label_91.setMaximumSize(QSize(16777215, 71))
        ...
        self.label_92.setMaximumSize(QSize(16777215, 68))
        ...
        self.toolButton_p1b = QToolButton(self.frame_30)
        ...
        self.horizontalLayout_13.addWidget(self.toolButton_p1b)
        ...
        self.toolButton_p1f = QToolButton(self.frame_30)
        ...
        self.horizontalLayout_13.addWidget(self.toolButton_p1f)
        ...
        self.stackedWidget_bar.addWidget(self.page)
        self.page_2 = QWidget()
        ...
        self.stackedWidget_bar.addWidget(self.page_2)
        self.page_4 = QWidget()
...
"}")
        ...
        self.stackedWidget_bar.addWidget(self.page_4)

        self.horizontalLayout_10.addWidget(self.stackedWidget_bar)
...
"            }")
        ...
        self.stackedWidget_bar.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_87.setText(QCoreApplication.translate("MainWindow", u"3", None))
        self.label_108.setText(QCoreApplication.translate("MainWindow", u"10 -", None))
        self.label_130.setText(QCoreApplication.translate("MainWindow", u"4", None))
        ...
        self.label_131.setText(QCoreApplication.translate("MainWindow", u"5", None))
